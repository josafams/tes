  ...
  return (
    <>
      ...
      <Container>
        ...
        <Profile iconLeft typeWalet name="Minha Carteira" onPress={() => {}} />
        ...
        <Profile iconLeft typeCall name="Central Serviços" onPress={() => {}} />

        <ViewFooter>
          <TouchableOpacity>
            <ViewIconButton>
              <SignOut size={36} weight="light" color={COLORS.PURPLE_CARD} />
            </ViewIconButton>
          </TouchableOpacity>
